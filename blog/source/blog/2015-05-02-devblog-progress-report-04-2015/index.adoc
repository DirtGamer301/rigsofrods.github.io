...
Again, I encourage everyone to http://rigsofrods.com/threads/119110[download a test build and check his favourite vehicles]. They should work a lot better now.
